  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative">
        ...
        {/* Back button */}
        <Link href="/events" className="absolute top-4 left-4 bg-white/20 backdrop-blur-sm p-2 rounded-full">
      ...
      <div className="relative -mt-8 bg-white rounded-t-3xl px-4 pt-6">
        ...
        <Tabs 
          ...
          onSelectionChange={(key) => setActiveTab(key.toString() as 'about' | 'photos' | 'map' | 'qrcode')}
        ...
        <div className="mb-20 mt-4">
                ...
                <Accordion variant="bordered" className="mt-4">
                  ...
                  >
                    <div className="space-y-3 text-gray-600">
                      <p><strong>Association des Citoyens Engagés</strong></p>
                      <p>Organisation à but non lucratif visant à promouvoir l&apos;engagement citoyen et la participation aux débats démocratiques.</p>
                      <p><strong>Contact :</strong> contact@ace-democratie.org</p>
                    </div>
                  </AccordionItem>
                </Accordion>
              </div>
                  ...
                  <CardBody className="flex justify-between items-center p-4">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Accès privilégié, Rencontre avec les intervenants</p>
                      </div>
                    </div>
          ...
          {activeTab === 'qrcode' && (
            <div className="text-center py-6">
              <h2 className="text-lg font-bold mb-6">Scannez ce code pour rejoindre l&apos;événement</h2>
              <EventQRCode eventId={event.id} eventName={event.name} />
              <p className="mt-6 text-sm text-gray-500">
                Partagez ce QR code pour inviter d&apos;autres personnes à rejoindre cet événement politique.
              </p>
            </div>
          )}
        </div>
