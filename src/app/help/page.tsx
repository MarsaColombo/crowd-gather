  ...
  const faqs = [
    {
      ...
      answer: 'You can access your tickets by navigating to the My Events section. There you\'ll find all your registered events and their associated tickets.'
    },
    {
      id: '2',
      question: 'How do I purchase a ticket?',
      answer: 'To purchase a ticket, navigate to the event details page and click on the "Book Now" button. Follow the instructions to complete your purchase.'
    },
    {
      id: '3',
      question: 'Can I get a refund or exchange my ticket?',
      answer: 'Refund policies vary by event. Please check the event details page for specific refund information or contact the event organizer directly.'
    }
  ];
